...
public class InventoryScroll {
	...
	public void render() {
		...
		if (viewStart != 0)
			inventory.setItem(getSuggestedRow(), getSuggestedCol(), InventoryHelper.getBase64Head("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZjZkYWI3MjcxZjRmZjA0ZDU0NDAyMTkwNjdhMTA5YjVjMGMxZDFlMDFlYzYwMmMwMDIwNDc2ZjdlYjYxMjE4MCJ9fX0=", org.bukkit.ChatColor.YELLOW + "" + ChatColor.BOLD + "LEFT", null, this::scrollLeft), () -> {});
		else {
			inventory.addMargin(suggestedRow, suggestedCol);
		}
		if (viewEnd != entireView.size())
			inventory.setItem(getSuggestedRow(), getSuggestedCol() + 1, InventoryHelper.getBase64Head("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOGFhMTg3ZmVkZTg4ZGUwMDJjYmQ5MzA1NzVlYjdiYTQ4ZDNiMWEwNmQ5NjFiZGM1MzU4MDA3NTBhZjc2NDkyNiJ9fX0=", org.bukkit.ChatColor.YELLOW + "" + ChatColor.BOLD + "RIGHT", null, this::scrollRight), () -> {});
		else {
